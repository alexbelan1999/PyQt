...
class Ui_Progress_training(object):
    def setupUi(self, Progress_training):
        ...
        Progress_training.setFixedSize(450, 150)
        ...
        self.progressBar.setGeometry(QtCore.QRect(100, 50, 250, 25))
        self.progressBar.setFont(font)
        self.progressBar.setObjectName("progressBar")

        self.pushButton_menu = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_menu.setGeometry(QtCore.QRect(100, 90, 140, 30))
        self.pushButton_menu.setFont(font)
        self.pushButton_menu.setDisabled(True)
        self.pushButton_menu.setObjectName("pushButton_menu")

        self.pushButton_exit = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_exit.setGeometry(QtCore.QRect(260, 90, 90, 30))
