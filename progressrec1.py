...
class Ui_Progress_recognition1(object):
    def setupUi(self, Progress_recognition1):
        ...
        Progress_recognition1.setFixedSize(350, 340)
        ...
        self.textEdit.setGeometry(QtCore.QRect(50, 140, 250, 100))
        self.textEdit.setFont(font)
        self.textEdit.setObjectName("textEdit")

        self.pushButton_report = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_report.setGeometry(QtCore.QRect(50, 250, 250, 30))
        ...
        self.pushButton_menu.setGeometry(QtCore.QRect(50, 290, 140, 30))
        self.pushButton_menu.setFont(font)
        self.pushButton_menu.setObjectName("pushButton_menu")

        self.pushButton_exit = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_exit.setGeometry(QtCore.QRect(200, 290, 100, 30))
