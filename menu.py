...
class Ui_Menu(object):
    def setupUi(self, Menu):
        ...
        self.pushButton_training.setGeometry(QtCore.QRect(70, 20, 140, 30))
        ...
        self.pushButton_recognition.setGeometry(QtCore.QRect(220, 20, 140, 30))
        ...
        self.pushButton_db.setGeometry(QtCore.QRect(70, 60, 140, 30))
        self.pushButton_db.setFont(font)
        self.pushButton_db.setObjectName("pushButton_db")

        self.pushButton_exit = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_exit.setGeometry(QtCore.QRect(220, 100, 140, 30))
        self.pushButton_exit.setFont(font)
        self.pushButton_exit.setObjectName("pushButton_exit")

        self.pushButton_back = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_back.setGeometry(QtCore.QRect(70, 100, 140, 30))
        self.pushButton_back.setFont(font)
        self.pushButton_back.setObjectName("pushButton_back")

        self.pushButton_info = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_info.setGeometry(QtCore.QRect(220, 60, 140, 30))
