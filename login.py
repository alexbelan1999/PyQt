...
class Ui_Login(object):
    def setupUi(self, Login):
        ...
        self.pushButton_test.setGeometry(QtCore.QRect(170, 320, 90, 30))
        self.pushButton_test.setFont(font)
        self.pushButton_test.clicked.connect(self.btnTest)
        self.pushButton_test.setObjectName("pushButton_test")

        self.label_check = QtWidgets.QLabel(self.centralwidget)
        self.label_check.setGeometry(QtCore.QRect(170, 360, 90, 30))
